...
1. The policy documents can be found [here](https://github.com/kevalrmenon/Policy+Documents)
...
![](https://github.com/kevalrmenon/images/arch1.png)
![](https://github.com/kevalrmenon/images/arch2.png)
...
- Clone the github repository
  ```shell
  $ git clone https://github.com/kevalrmenon/Semantic_spotter.git
  ```
- Open
  the [notebook](https://github.com/kevalrmenon/Semantic_spotter/blob/main/semantic-spotter-langchain-notebook.ipynb)
